            ...
            <div className="container mx-auto flex flex-col items-center justify-between gap-4 py-10 md:h-24 md:flex-row md:py-0 px-4">
                <div className="flex flex-col items-center gap-4 px-8 md:flex-row md:gap-2 md:px-0">
                    <p className="text-center text-sm leading-loose text-muted-foreground md:text-left">
                        © {new Date().getFullYear()} Πολιτιστικός Σύλλογος Μέσης. Επικοινωνία: <a href="mailto:ps-mesis@gmail.com" className="hover:text-primary underline underline-offset-4">ps-mesis@gmail.com</a>
                    </p>
                </div>
