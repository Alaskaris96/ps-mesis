...
const eras = [
    { name: 'Αγώνας & Αντίσταση', years: '1900 - 1945', start: 0, end: 0.25 },
    { name: 'Προσφυγική Σμίξη', years: '1922 - 1930', start: 0.25, end: 0.5 },
    { name: 'Η Μετακίνηση', years: '1940 - 1960', start: 0.5, end: 0.75 },
    { name: 'Σύγχρονη Εποχή', years: 'Σήμερα', start: 0.75, end: 1 },
];
        ...
        <div className="bg-background text-foreground min-h-screen pb-20 overflow-hidden" ref={containerRef}>
            ...
            <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-20 text-center px-4">
                    ...
                    >
                        Η διαδρομή μιας κοινότητας που έμαθε να δαμάζει το νερό, να καλλιεργεί τη γη με πείσμα και να αναγεννιέται μέσα από τις δυσκολίες.
                    </motion.p>
                </div>
            </section>
            ...
            <section className="py-16 bg-muted/30">
                <div className="container mx-auto px-4">
                    <div className="max-w-3xl mx-auto text-center space-y-8">
                        <h2 className="text-3xl md:text-4xl font-serif">Το Χρονικό της Μέσης</h2>
                        <p className="text-xl text-muted-foreground leading-relaxed italic">
                            &quot;Από τις όχθες του Αλιάκμονα στη σημερινή ασφαλή εστία, η ιστορία μας είναι ένα χρονικό εργατικότητας, ηρωισμού και προσφοράς.&quot;
                        </p>
            ...
            <section className="mt-32 py-20 bg-primary/5 border-y border-primary/10">
                <div className="container mx-auto px-4 text-center">
                    <div className="max-w-2xl mx-auto space-y-6">
                        ...
                        <h3 className="text-2xl font-serif">Τουρισμός και Περιβάλλον</h3>
                        <p className="text-lg text-muted-foreground leading-relaxed">
                            Η Μέση αναδεικνύεται σε κέντρο εναλλακτικού τουρισμού λόγω των <strong>Ανθισμένων Ροδακινιών</strong>, που κάθε Μάρτιο μεταμορφώνουν τον κάμπο σε μια απέραντη ροζ θάλασσα. Παράλληλα, η γειτνίαση με τον <strong>Αλιάκμονα</strong> προσφέρει μοναδικές φυσιολατρικές διαδρομές.
                        </p>
                    </div>
                </div>
            </section>
